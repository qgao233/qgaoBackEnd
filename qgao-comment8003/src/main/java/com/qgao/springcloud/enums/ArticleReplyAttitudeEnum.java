...
public enum ArticleReplyAttitudeEnum {

    GOOD("0","reply_good_count","赞")
    ,BAD("1","reply_bad_count","踩")
    ;
    ...
    ArticleReplyAttitudeEnum(String code,String field, String info) {
        this.code = code;
        this.field = field;
        this.info = info;
    }
    ...
    public static String getCode(String info){
        for(ArticleReplyAttitudeEnum tmpEnum:values()){
